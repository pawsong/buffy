export default {
   ...
   */
  'invalidEmail': '이메일 주소가 올바르지 않습니다',
   ...
   */
  'join.form.haveAccount': '계정이 있으세요?',
  ...
  /**
   * path: src/screens/Join/JoinHandler.json
   ...
   */
  'localLoginFailed': '이메일과 패스워드가 일치하지 않습니다',
  ...
  /**
   * path: src/screens/Login/components/LoginForm.json
   * description: Login form heading message
   * defaultMessage: Log in to {service}
   */
  'login.form.heading': '{service}에 로그인하세요',
   ...
   */
  'login.form.newToService': '{service}에 처음이세요?',
