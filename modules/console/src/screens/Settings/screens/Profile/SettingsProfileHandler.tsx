...
const styles = require('./SettingsProfileHandler.css');
...
@injectIntl
@withStyles(styles)
class SettingsProfileHandler extends React.Component<HandlerProps, HandlerState> {
  ...
  render() {
    ...
    return (
      <div>
        <div className={styles.fieldLabel} style={{ marginTop: 0 }}>
          {this.props.intl.formatMessage(messages.profilePicture)}
        </div>
